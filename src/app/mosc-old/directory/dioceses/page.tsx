        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-6" role="search" aria-label="Search dioceses by name">
            <form method="get" action={BASE_PATH} className="flex flex-wrap gap-2 items-center">
              ...
              />
              <button type="submit" className="font-body font-medium inline-flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-lg hover:opacity-90 reverent-transition" aria-label="Search">
